...
cmd.utils.raw__GT_clj = (function raw__GT_clj(raw){var json = JSON.parse(raw);var clj = cljs.core.js__GT_clj.call(null,json);cmd.utils.say.call(null,json);
return clj;
});
cmd.utils.setcookie = (function setcookie(name,value){return goog.net.cookies.set(name,value,-1);
});
goog.exportSymbol('cmd.utils.setcookie', cmd.utils.setcookie);
cmd.utils.getcookie = (function getcookie(name){return goog.net.cookies.get(name);
});
goog.exportSymbol('cmd.utils.getcookie', cmd.utils.getcookie);
