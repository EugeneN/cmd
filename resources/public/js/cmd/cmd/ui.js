...
return (function calc_offset_top_preview(ot1){var ch1 = (session.getScreenLength() * editor.renderer.lineHeight);var ch2 = cmd.ui.preview.clientHeight;cmd.utils.say.call(null,[cljs.core.str("ace height"),cljs.core.str(ch1)].join(''));
return ((ot1 * ch2) / ch1);
});})(editor,session))
;
cmd.ui.calc_offset_top_input = ((function (editor,session){
return (function calc_offset_top_input(ot2){var ch1 = (session.getScreenLength() * editor.renderer.lineHeight);var ch2 = cmd.ui.preview.clientHeight;cmd.utils.say.call(null,[cljs.core.str("ace height"),cljs.core.str(ch1)].join(''));
return ((ot2 * ch1) / ch2);
});})(editor,session))
;
