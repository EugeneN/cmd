...
goog.require('sablono.util');
goog.require('clojure.string');
sablono.interpreter.IInterpreter = (function (){var obj14410 = {};return obj14410;
})();
sablono.interpreter.interpret = (function interpret(this$){if((function (){var and__3851__auto__ = this$;if(and__3851__auto__)
...
{var x__4490__auto__ = (((this$ == null))?null:this$);return (function (){var or__3863__auto__ = (sablono.interpreter.interpret[goog.typeOf(x__4490__auto__)]);if(or__3863__auto__)
{return or__3863__auto__;
} else
{var or__3863__auto____$1 = (sablono.interpreter.interpret["_"]);if(or__3863__auto____$1)
...
sablono.interpreter.wrap_form_element = (function wrap_form_element(ctor,react_name){return React.createClass({"render": (function (){var this$ = this;return this$.transferPropsTo(ctor.call(null,{"children": (this$.props["children"]), "onChange": (this$["onChange"]), "value": (this$.state["value"])}));
...
}), "displayName": react_name});
});
sablono.interpreter.input = sablono.interpreter.wrap_form_element.call(null,React.DOM.input,"OmInput");
sablono.interpreter.textarea = sablono.interpreter.wrap_form_element.call(null,React.DOM.textarea,"OmTextarea");
sablono.interpreter.option = sablono.interpreter.wrap_form_element.call(null,React.DOM.option,"OmOption");
