...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t14280 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.async.impl.channels.t14280 = (function (val,box,meta14281){
this.val = val;
this.box = box;
...
cljs.core.async.impl.channels.t14280.cljs$lang$type = true;
cljs.core.async.impl.channels.t14280.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t14280";
cljs.core.async.impl.channels.t14280.cljs$lang$ctorPrWriter = (function (this__4430__auto__,writer__4431__auto__,opt__4432__auto__){return cljs.core._write.call(null,writer__4431__auto__,"cljs.core.async.impl.channels/t14280");
});
cljs.core.async.impl.channels.t14280.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t14280.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_14282){var self__ = this;
var _14282__$1 = this;return self__.meta14281;
});
cljs.core.async.impl.channels.t14280.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_14282,meta14281__$1){var self__ = this;
var _14282__$1 = this;return (new cljs.core.async.impl.channels.t14280(self__.val,self__.box,meta14281__$1));
});
cljs.core.async.impl.channels.__GT_t14280 = (function __GT_t14280(val__$1,box__$1,meta14281){return (new cljs.core.async.impl.channels.t14280(val__$1,box__$1,meta14281));
});
}
return (new cljs.core.async.impl.channels.t14280(val,box,null));
});
...
cljs.core.async.impl.channels.PutBox.cljs$lang$ctorPrWriter = (function (this__4433__auto__,writer__4434__auto__,opts__4435__auto__){return cljs.core._write.call(null,writer__4434__auto__,"cljs.core.async.impl.channels/PutBox");
});
...
cljs.core.async.impl.channels.ManyToManyChannel.cljs$lang$ctorPrWriter = (function (this__4430__auto__,writer__4431__auto__,opt__4432__auto__){return cljs.core._write.call(null,writer__4431__auto__,"cljs.core.async.impl.channels/ManyToManyChannel");
});
...
{self__.closed = true;
while(true){
var taker_14283 = self__.takes.pop();if((taker_14283 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_14283))
{var take_cb_14284 = cljs.core.async.impl.protocols.commit.call(null,taker_14283);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_14284,taker_14283,this$__$1){
return (function (){return take_cb_14284.call(null,null);
});})(take_cb_14284,taker_14283,this$__$1))
);
} else
{}
{
