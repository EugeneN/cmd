...
goog.require('goog.events');
clojure.browser.event.EventType = (function (){var obj10478 = {};return obj10478;
})();
clojure.browser.event.event_types = (function event_types(this$){if((function (){var and__3851__auto__ = this$;if(and__3851__auto__)
...
{var x__4490__auto__ = (((this$ == null))?null:this$);return (function (){var or__3863__auto__ = (clojure.browser.event.event_types[goog.typeOf(x__4490__auto__)]);if(or__3863__auto__)
{return or__3863__auto__;
} else
{var or__3863__auto____$1 = (clojure.browser.event.event_types["_"]);if(or__3863__auto____$1)
...
return (function (p__10479){var vec__10480 = p__10479;var k = cljs.core.nth.call(null,vec__10480,0,null);var v = cljs.core.nth.call(null,vec__10480,1,null);return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.call(null,k.toLowerCase()),v], null);
});})(this$__$1))
...
return (function (p__10481){var vec__10482 = p__10481;var k = cljs.core.nth.call(null,vec__10482,0,null);var v = cljs.core.nth.call(null,vec__10482,1,null);return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.call(null,k.toLowerCase()),v], null);
});})(this$__$1))
,cljs.core.merge.call(null,cljs.core.js__GT_clj.call(null,goog.events.EventType))));
});
