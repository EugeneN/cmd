...
{{
var G__10253 = cljs.core.pop.call(null,v__$1);
v__$1 = G__10253;
continue;
}
} else
...
{var pred__10257 = cljs.core._EQ_;var expr__10258 = limit;if(cljs.core.truth_(pred__10257.call(null,1,expr__10258)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__10257.call(null,2,expr__10258)))
...
var G__10260 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__10261 = (limit__$1 - 1);
var G__10262 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__10260;
limit__$1 = G__10261;
parts = G__10262;
continue;
...
{var ch = s.charAt(index);var temp__4124__auto___10264 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4124__auto___10264))
{var replacement_10265 = temp__4124__auto___10264;buffer.append([cljs.core.str(replacement_10265)].join(''));
} else
{buffer.append(ch);
}
{
var G__10266 = (index + 1);
index = G__10266;
continue;
}
}
