...
{{
var G__14395 = cljs.core.pop.call(null,v__$1);
v__$1 = G__14395;
continue;
}
} else
...
{var pred__14399 = cljs.core._EQ_;var expr__14400 = limit;if(cljs.core.truth_(pred__14399.call(null,1,expr__14400)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__14399.call(null,2,expr__14400)))
...
var G__14402 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__14403 = (limit__$1 - 1);
var G__14404 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__14402;
limit__$1 = G__14403;
parts = G__14404;
continue;
...
{var ch = s.charAt(index);var temp__4124__auto___14406 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4124__auto___14406))
{var replacement_14407 = temp__4124__auto___14406;buffer.append([cljs.core.str(replacement_14407)].join(''));
} else
{buffer.append(ch);
}
{
var G__14408 = (index + 1);
index = G__14408;
continue;
}
}
